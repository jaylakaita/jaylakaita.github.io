...
<header>1. Describe the web-application you intend to build (in detail please!)</header>
...
<b>1.A Login Page: There will be two options to login…</b>
...
<b>New User Registration Page (File I/O to store new user data)</b>
